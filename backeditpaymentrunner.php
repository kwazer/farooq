...
$other = $other_ledger;
echo $other_ledger." ".$narration." ".$sno." "." ".$amount;
$queryUpdate = mysqli_query($con,"update daybook set ledger_id = '$other',narration  ='$narration',date ='$date',amount='$amount' where sno = $sno");
$flag_update = false;
