...
<?php echo "<form action = \"backissuebook.php\" method = \"post\" onsubmit = \"return submit_item(this)\">";?>
<!--<?php //echo "<form action = \"addbooks.php\" method = \"get\" id = \"item_form\" onsubmit = \"additem($cat_id,'".$cat_name."')\">";?>-->
<big style = "font-size:28px;color:grey;letter-spacing:2px;"><?php echo $cat_name;?></big><span style = "font-size:20px;color:grey;"> Receipt Book Issue</span> <?php echo "<span style = \"cursor:pointer;color:brown;margin-left:10px;border:0px solid black;padding:3px;\" onclick = \"redirect_back(".$cat_id.",'".$cat_name."')\">Back</span>";?><br><hr>
<table>
...
<tr><td><span>Alpha serial</span></td><td><input class = "lis" type = "text" name= "item_name" placeholder="Item Name" id = "add_name" autofocus onkeypress= "if(event.keyCode == 13) document.getElementById('max_price').focus();"/></td></tr>
...
<tr><td><span>Book Begin</span></td><td><input class = "lis" type =  "text" id = "cost_price" placeholder = "publisher Discount" name = "publisher_discount" onkeypress= "if(event.keyCode == 13) document.getElementById('dealer_price').focus();"/></td></tr>
<tr><td><span>Book End</span></td><td><input class = "lis" type =  "text" id = "dealer_price" name = "dealer_discount" placeholder="dealer discount" onkeypress= "if(event.keyCode == 13) document.getElementById('mrp_discount').focus();"/></td></tr>
