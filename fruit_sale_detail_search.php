...
echo "</datalist>";
$query = mysqli_query($con,"select * from fruit_sale_detail where bill_no = '$tran_id'");
...
echo "<tr><td><input list = 'eList' type = 'text' name = 'sfruit_input' id = 'sfruit_input' oninput = 'fill_s_ledger_id()'/></td><td><input id = 'peti' oninput = 'lock_other(\"dabba\")' type = 'text' style = 'width:35px;'/></td><td><input onkeydown = 'lock_other(\"peti\")' id = 'dabba' type = 'text' style = 'width:35px;'/></td><td><input id = 'variety' type = 'text' style = 'width:100px;'/><td><input id = 'quality' type = 'text' /></td><td><input id = 'rate' type = 'text'  style = 'width:50px;' onkeyup = 'addon_details($tran_id)'/></td><td><input id = 'tamount' type = 'text'  style = 'width:70px;' disabled/></td></tr>";
...
//echo "<tr><td><input list = 'eList' type = 'text' id = 'sfruit_input".$row['sno']."' oninput = 'fill_s_ledger_id_update(".$row['sno'].")' value = '".$row['khata']."'/></td><td><input id = 'peti".$row['sno']."' oninput = 'lock_other(\"dabba\")' value = '".$row['peti']."' type = 'text' style = 'width:35px;'/></td><td><input onkeydown = 'lock_other(\"peti\")' value = '".$row['dabba']."' id = 'dabba".$row['sno']."' type = 'text' style = 'width:35px;'/></td><td><input id = 'variety".$row['sno']."' value = '".$row['variety']."' type = 'text' style = 'width:100px;'/><td><input id = 'quality".$row['sno']."' value = '".$row['quality']."' type = 'text' /></td><td><input id = 'rate".$row['sno']."' value = '".$row['rate']."' type = 'text'  style = 'width:50px;'/></td><td><input id = 'amount".$row['sno']."' type = 'text'  style = 'width:70px;' value = '".$row['amount']."'/></td><td><button onclick = update_fruit_sale(".$row['sno'].")>Save</button><button style = 'left-margin:5px;' onclick = delete_fruit_sale(".$row['sno'].")>Del</button></td></tr>";
echo "<tr><td><input list = 'eList' type = 'text' id = 'sfruit_input".$row['sno']."' oninput = '' value = '".$row['khata']."'/></td><td><input id = 'peti".$row['sno']."' oninput = 'lock_other(\"dabba\")' value = '".$row['peti']."' type = 'text' style = 'width:35px;'/></td><td><input onkeydown = 'lock_other(\"peti\")' value = '".$row['dabba']."' id = 'dabba".$row['sno']."' type = 'text' style = 'width:35px;'/></td><td><input id = 'variety".$row['sno']."' value = '".$row['variety']."' type = 'text' style = 'width:100px;'/><td><input id = 'quality".$row['sno']."' value = '".$row['quality']."' type = 'text' /></td><td><input id = 'rate".$row['sno']."' value = '".$row['rate']."' type = 'text'  style = 'width:50px;'/></td><td><input id = 'amount".$row['sno']."' type = 'text'  style = 'width:70px;' value = '".$row['amount']."'/></td><td><button onclick = update_fruit_sale(".$row['sno'].")>Save</button><button style = 'left-margin:5px;' onclick = delete_fruit_sale(".$row['sno'].")>Del</button></td></tr>";
}
echo "</table>";
