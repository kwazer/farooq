...
$query = mysqli_query($con,"insert into daybook(date,amount,transaction_type,ledger_id,transaction_id,fund_flow,narration,log_date) values('".$date."',$amount,'$transaction_type',$ledger_id,'$serial_no','1','$other_ledger',CURDATE())");
if($query)
{
	echo "successful";
}
