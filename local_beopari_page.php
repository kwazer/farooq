...
//echo $ledger_id;
$query_ledger = mysqli_query($con,"select * from ledgers where ledger_id = $ledger_id");
while ($row_opening= mysqli_fetch_array($query_ledger))
{
	$opening = $row_opening['opening_balance'];
	$date = $row_opening['ledger_date'];
	$tot_payment = $tot_payment + $opening;
	$gdp = $gdp + $opening;
}
...
if($opening > 0)
{
echo "<tr><td style = 'text-align:left;'>".$date."</td><td style = 'text-align:left;'>Opening Balance</td><td style = 'text-align:right;'>".$opening."</td><td style = 'text-align:right;'></td><td style = 'text-align:right;'></td><td style = 'text-align:right;'></td></tr>";
}
else
{
echo "<tr><td style = 'text-align:left;'>".$date."</td><td style = 'text-align:left;'>Opening balance</td><td style = 'text-align:right;'></td><td style = 'text-align:right;'></td><td style = 'text-align:right;'></td><td style = 'text-align:right;'>".$opening."</td></tr>";
}
