...
//alert(cate);
	...
	function clio(caty,catna)
	{
		...
		xmlhttp.open("GET","backrunnerreports.php?cat_id="+caty+"&cat_name="+catna,true);
		xmlhttp.send();
	}
	function orderlist()
	{
	...
	function show_itempage(publisher_name,publisher_id,item_id)
	{
		...
		xmlhttp.open("GET","bookpage.php?item_id="+item_id+"&cat_id="+publisher_id,true);
		xmlhttp.send();
...
<div style = "border-left: 0px solid black;width:730px;margin-left:120px;margin-top:20px;padding:5px;" id= "prose">
	<!--<ul>
