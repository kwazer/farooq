...
echo "<input type = 'text' list = 'exampleList' name = 'example' id = 'example_input' oninput = 'showdatalist_value(".$sno.")' style = 'width:88%;height:28px;border:2px solid green;' autofocus/>";
