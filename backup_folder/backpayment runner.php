...
//	echo "<tr onclick = 'insert_details(this.rowIndex,".$row['transaction_id'].",".$row['type_id'].");'><td>";
	echo "<tr ><td>";
echo "<input type = 'text' list = 'eexampleList' value = '".$row['runner_name']."' name = 'eexample' id = 'eexample_input' oninput = 'showdatalist_value()' style = 'width:100%;height:28px;' autofocus/>";
