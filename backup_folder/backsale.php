...
{
echo "<tr><td>".$row['name']."</td><td><input onKeyUp = 'if(event.keyCode == 13)alter_qty(".$row['sno'].",this.value,".$row['retail_rate'].");' style = 'width:50px;text-align:center;' value = '".$row['qty']."' type = 'text'/></td><td>".$row['retail_rate']."</td><td>".$row['author_name']."</td><td style = 'text-align:right;' id = 'p".$row['sno']."'>".$row['total']."</td></tr>";
}
