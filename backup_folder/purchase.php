...
echo "<tr><td class = 'lisst' ><span>Bill NO : </span></td><td style = 'text-align:left;'>";
echo "<input style = 'width:100px;height:28px;' id = 'purchase_bill_no' name = 'purchase_bill_no' type = 'text'/></td></tr>";
...
$query_list_ledger = mysqli_query($con,"select * From ledgers where ledger_type = $sno");
