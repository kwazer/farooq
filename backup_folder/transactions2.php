...
/*	var transaction_type = document.getElementById("transaction_type").value;
 ...
 xhr.onreadystatechange=function()
 {
	 if(xhr.readyState == 4 && xhr.status == 200)
	 {
		if(g_type_id == 4 || g_type_id == 6 || g_type_id == 5 || g_type_id == 7 || g_type_id == 8 || g_type_id == 13 || g_type_id == 12 || g_type_id == 14)
		{
...
//alert(sno);
if(sno == 4 || sno == 6 || sno == 8 || sno == 10 || sno == 13 || sno == 12 || sno == 14 || sno == 15)
{
//	alert(value_to_send);
if(sno == 10)
...
//		alert(xhr.responseText);
	...
	xhr.open("GET","add_fruit_details.php?bill_no="+sno+"&peti="+peti+"&dabba="+dabba+"&ledger_id="+ledger_id+"&variety="+variety+"&quality="+quality+"&rate="+rate+"&amount="+amount+"&date="+date,true);
	xhr.send();
