...
//		echo $row_creditor['ledger_date'];
		echo "<p><big style = 'color:red;'><span> Ledger ID : ".$row_creditor['ledger_id']."</span><br>".$row_creditor['ledger_name']."</big><br><big>Opening Balance :".$opening_bal."</big><big>Ledger Date :".$ledger_date."</big></p>";
	}
}
echo "<br>";
