...
//	echo "<tr onclick = 'insert_details(this.rowIndex,".$row['transaction_id'].",".$row['type_id'].");'><td>";
	echo "<tr ><td>";
echo "<input type = 'text' list = 'eexampleList' value = '".$row['runner_name']."' name = 'eexample' id = 'eexample_input' oninput = 'showdatalist_value(".$row['sno'].")' style = 'width:100%;height:28px;' autofocus/>";
...
echo "</datalist>";
	echo "</td><td><input type = 'text' style = 'width:80px;' value = '".$row['date']."' name ='date' id = 'date".$row['sno']."'/></td><td>".$row['type_name']."</td><td>".$row['transaction_id']."</td><td><input name = 'narration' id = 'narration".$row['sno']."' type = 'text' style = 'width:80px;' value = '".$row['narration']."'/></td><td><input id  = 'amount".$row['sno']."' type = 'text' value='".$row['amount']."' name  = 'amount'/></td>";
		echo "<input type = 'text' name = 'other_ledgers' value = '".$row['runner_id']."' style = 'display:none;' id = 'other_ledgers".$row['sno']."'/>";
