...
/*	var transaction_type = document.getElementById("transaction_type").value;
 ...
 xhr.onreadystatechange=function()
 {
	 if(xhr.readyState == 4 && xhr.status == 200)
	 {
		if(g_type_id == 4 || g_type_id == 6 || g_type_id == 5 || g_type_id == 7 || g_type_id == 8 || g_type_id == 13 || g_type_id == 12 || g_type_id == 14 || g_type_id == 15)
		{
...
//              alert(xhr.responseText);
        ...
        xhr.open("GET","add_fruit_details.php?bill_no="+sno+"&peti="+peti+"&dabba="+dabba+"&ledger_id="+ledger_id+"&variety="+variety+"&quality="+quality+"&rate="+rate+"&amount="+a$
        xhr.send();
