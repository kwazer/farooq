...
echo "<tr style = 'text-align:center;' ><td colspan = '7' style = 'border:1px solid black;text-align:center;width:100%;color:black;'><span  style = 'float:right;color:black;font-weight:normal;font-size:12px;'><h4>T : 01951-254400<br>C: 919419434400<br>C: 919018184400<br>C: 919797274400</h4></span><h2 ><span id = 'font-face' style = 'letter-spacing:1px;'>FAROOQ FRUIT CO</span><br> <span style = 'font-size:15px;color:black;font-weight:normal;'><span style = 'color:black;padding:1px 4px;font-weight:bold;font-style:italic;border-radius:5px;'>Fruit Grower Commission & Forwarding Agents </span><br>55,56 Fruit & Vegetable Market<br>Zaloosa Charari-Sharief, Kashmir - 191112</span></h2></td></tr>";
echo "</table>";	
...
echo "<tr><td style = 'border-top-style:solid;border-color:grey;border-width:2px;'>Balance <span style = 'float:right;'>=</span></td><td style = 'text-align:right;border-top-style:solid;border-color:grey;border-width:2px;font-size:18px;'>";
...
//echo "table list";
echo "<table style = 'width:850px;position:fixed;bottom:0;border-top-style:solid;border-color:grey;border-width:2px;'>";
echo "<tr>";
