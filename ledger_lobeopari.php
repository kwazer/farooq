...
{
	echo "<tr onclick = 'lobeopari_page(".$row['ledger_id'].",\"".$row['ledger_name']."\")' style = 'border-width:1px;border-color:peachpuff;border-bottom-style:solid;'><td style = 'border-bottom-style:solid;border-color:red;border-width:1px;'>L".$row['ledger_id']."</td><td style = 'text-align:left;border-bottom-style:solid;border-color:red;border-width:1px;'>".$row['ledger_name']."</td></tr>";
}
echo "</table>";
echo "</div>";
?>
