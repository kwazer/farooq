...
echo "<input type = 'text' list = 'exampleList' name = 'example' id = 'example_input' oninput = 'showdatalist_value(".$sno.")' style = 'width:88%;height:28px;border:2px solid green;'/>";
...
echo "</datalist></span>";
echo "<span><input type = 'text' style = 'width:12%;height:28px;color:red;' id = 'account_no' disabled/></span>";
...
//echo "</td><td><input type = 'text' style = 'width:50px;' id = 'account_no'/></td></tr>";
echo "<tr><td class = 'lisst'><span >Receipt No :</span></td><td><input style = 'width:35%;height:28px;' type = 'text' name = 'alpha_serial' placeholder = 'alpha serial' value = '$alpha_serial' /><input style = 'width:65%;height:28px;' type = 'text' name = 'example'/></td></tr>";
...
echo "<tr><td class = 'lisst' ><span>Narration : </span></td><td><input name = 'narration' id=\"narration\" style = \"padding:5px;width:100%;font-size:15px;\" type = 'text' value = 'cash'></td></tr>";
