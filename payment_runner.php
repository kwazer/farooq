...
$query_se = mysqli_query($con,"select DATE_FORMAT(date,'%d-%m-%Y') as date,transaction_id From daybook where transaction_type = '$sno' order by transaction_id desc limit 1");
