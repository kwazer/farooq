...
if($transaction_type == 10)
{
echo "<tr><td colspan = '2'>".$row['name']."</td><td colspan = '2'>".$row['qty']." x ".$row['amount']."</td><td style = 'text-align:right;padding-right:80px;'>".sprintf("%.2f",$row['total'])."</td>";
//echo "<td style = 'text-align:right;' id = 'p".$row['sno']."'>".$row['total']."</td>";
echo "</tr>";
}
else
{
echo "<tr><td>".$row['name']."</td><td><input style = 'width:50px;text-align:center;' value = '".$row['qty']."' type = 'text'/></td><td>".$row['retail_rate']."</td><td>".$row['author_name']."</td><td style = 'text-align:right;padding-right:80px;'>".sprintf("%.2f",$row['total'])."</td></tr>";
}
...
echo "<tr style = 'border-top-style:solid;border-color:grey;border-width:1px;'><td colspan = '2'></td><td style = 'font-weight:bold;'>Grand Total</td><td style = 'text-align:right;font-weight:bold;' id = 'grand_total'>".sprintf("%.2f",$grand_total)."</td></tr>";
