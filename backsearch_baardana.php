...
while($ro_ledger = mysqli_fetch_array($query_list_ledger))
{
 ...
 $query = mysqli_query($con,"select * from daybook join transaction_type on daybook.transaction_type = transaction_type.type_id join ledgers using (ledger_id) where transaction_type = '10' and transaction_id = '$other_ledger'");
echo "<table style = 'width:100%;' id = 'view_table'>";
echo "<tr><th style = 'width:250px;'>Ledger Name</th><th>Date</th><th>Type</th><th>Tr ID</th><th>Folio #</th><th>Amount</th></tr>";
