...
<?php
$query_date = mysqli_query($con,"select date from daybook where transaction_type = '$sno' order by sno desc limit 1");
...
echo "<tr><td class = 'lisst'><span>Date : </span></td><td style = 'text-align:left;'><input type = 'date' name = 'date' style = 'width:250px;height:28px;' id= 'date'  placeholder = 'DD-MM-YYYY' value = '$date_fill'/></td>";
echo "<td class = 'lisst'><span>Folio Head : </span></td><td><input type = 'text' name = 'narration' style = 'width:100%;height:28px;' id= 'receipt_narration' /></td></tr>";
echo "<tr><td class = 'lisst' ><span>Party Name : </span></td><td colspan = '3'>";
...
echo "<input type = 'text' list = 'exampleList' name = 'example' id = 'example_input' oninput = 'showdatalist_value($sno)' style = 'width:88%;height:28px;' autofocus/>";
...
echo "</datalist>";
echo "<span><input type = 'text' style = 'width:12%;height:28px;color:red;font-weight:bold;font-size:18px;' id = 'account_no' disabled/></span>";


echo "</td><td class = 'lisst' ><span></span></td><td></td></tr>";
...
echo "</td>";
//echo "<tr></tr>";
echo "<td style = 'text-align:right;'><input name = 'qty' id=\"qty\" style = \"padding:5px;width:70px;font-size:15px;\" type = 'text' placeholder = 'quantity'></td>";
