...
echo "<tr><td><label style = 'font-size:18px;font-style:italic;'>Enter goods receipt serial</label></td><td><input onkeypress = 'update_query(this.value)' style = 'height:28px;width:100%;' type = 'text' name = 'transaction_id' id = 'transaction_id'/></td><td><button value = 'Search' style = 'font-style:italic;' >Search</button></td></tr>";
echo "</table>";
if(isset($tran_id))
{
...
$query_search = mysqli_query($con,"select * from daybook left join ledgers using (ledger_id) where transaction_type = 16 and transaction_id = '$tran_id'");
