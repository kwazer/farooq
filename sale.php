...
echo "<td class = 'lisst'><span>Phone No : </span></td><td><input type = 'text' name = 'narration' style = 'width:100%;height:28px;' id= 'receipt_narration' /></td></tr>";
...
echo "<input type = 'text' autocomplete = 'off' name = 'example' id = 'example_input' style = 'width:100%;height:28px;' autofocus/>";
...
echo "</datalist>";
echo "</td><td class = 'lisst'><span>Address : </span></td><td><input type = 'text' name = 'emiAmount' style = 'width:100%;height:28px;' id= 'emiAmount' /></td>";
