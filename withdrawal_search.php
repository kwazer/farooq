...
$query_ledger = mysqli_query($con,"select * from ledgers where ledger_type = 1");
...
//echo "</td></tr>";
echo "<tr><td class = 'lisst'><span >Payment Ledger Serial :</span></td><td><input style = 'width:65%;height:28px;' type = 'text' name = 'example'/></td></tr>";
