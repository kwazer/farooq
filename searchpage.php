...
function ledger_types(sno,ledger_type)

{
	...
	xhr.open("GET",ledger_type+".php?type_id="+sno+"&type_name="+ledger_type,true);
	xhr.send();
}
...
//	if($row['sno'] == 5)
//	{
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(1,'billsearch')\">Search Bill</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(2,'receiptsearch')\">Search Receipt</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(3,'credit_loan')\">Credit Loan</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(3,'payment runner')\">Payment Runner</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(4,'payment ledger')\">Payment ledger</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(5,'debit_loan')\">Debit Loan</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(6,'salesearch')\">Sale Search</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(7,'pending_search')\">Pending Bills</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(8,'withdrawal_search')\">Withdrawal</a> </td></tr>";
