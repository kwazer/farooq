...
//alert("saved");
  ...
  xhr.send();
	...
	function show_results(tran_id,b_type_id)
	{
//		alert(tran_id);
  var xhr = new XMLHttpRequest();
  xhr.onreadystatechange = function()
...
//alert("saved");
  ...
  if(b_type_id == 16)
  xhr.open("GET","goods_receipt_detail_search.php?tran_id="+tran_id,true);
else
  xhr.open("GET","fruit_sale_detail_search.php?tran_id="+tran_id,true);
  xhr.send();	
  }
  function update_goods_receipt(sno)
  {
	//  alert(sno);
	  		var peti = document.getElementById("peti"+sno).value;
	var dabba = document.getElementById("dabba"+sno).value;
	var rate = document.getElementById("rate"+sno).value;
//	if(event.keyCode == 13)
//	{
//	alert(sno);
//	var date = document.getElementById("date"+sno).value;
	var variety = document.getElementById("variety"+sno).value;	
	var marka = document.getElementById("marka"+sno).value;
	var quality = document.getElementById("quality"+sno).value;
	var amount = document.getElementById("amount"+sno).value;
	//var ledger_id = document.getElementById("s_ledger_id"+sno).value;
	var ledger_id = document.getElementById("sfruit_input"+sno).value;
	//alert(date);
...
//		document.getElementById("display-pod").innerHTML = xhr.responseText;
	...
	xhr.open("GET","update_goods_receipt.php?bill_no="+sno+"&peti="+peti+"&dabba="+dabba+"&ledger_id="+ledger_id+"&variety="+variety+"&quality="+quality+"&rate="+rate+"&amount="+amount+"&marka="+marka,true);
	xhr.send();

  
  }
  function update_fruit_sale(sno)
  {
	  		var peti = document.getElementById("peti"+sno).value;
	var dabba = document.getElementById("dabba"+sno).value;
	var rate = document.getElementById("rate"+sno).value;
...
//	var marka = document.getElementById("marka"+sno).value;
	...
	//alert(date);
	//alert(date+" "+peti+" "+dabba+" "+variety+" "+quality+" "+rate+" "+amount+" "+sno+" "+ledger_id);
//	alert(peti+" "+dabba+" "+variety+" "+quality+" "+rate+" "+amount+" "+sno+" "+ledger_id);
...
//	xhr.open("GET","update_fruit_details.php?bill_no="+sno+"&peti="+peti+"&dabba="+dabba+"&ledger_id="+ledger_id+"&variety="+variety+"&quality="+quality+"&rate="+rate+"&amount="+amount+"&marka="+marka,true);
	xhr.open("GET","update_fruit_details.php?bill_no="+sno+"&peti="+peti+"&dabba="+dabba+"&ledger_id="+ledger_id+"&variety="+variety+"&quality="+quality+"&rate="+rate+"&amount="+amount,true);
	xhr.send();

  
  }
  function fill_s_ledger_id_update(sno)
{
		var shownvalue = document.getElementById("sfruit_input"+sno).value;
	var datalist = document.getElementById("eList");
		var value_to_send = document.querySelector("#eList option[value='"+shownvalue+"']").id;
	//	alert(value_to_send);
document.getElementById("s_ledger_id"+sno).value = value_to_send;
}
function addon_details(sno)
{
		var peti = document.getElementById("peti").value;
	var dabba = document.getElementById("dabba").value;
	var rate = document.getElementById("rate").value;
	var ledger = document.getElementById("sfruit_input").value;
	if(event.keyCode == 13)
	{
//		alert("it works");
//	alert(sno);
	...
	var ledger_id = document.getElementById("s_ledger_id").value;
	//alert(date);
//	alert(date+" "+peti+" "+dabba+" "+variety+" "+quality+" "+rate+" "+amount+" "+sno+" "+ledger_id);
...
//      location.reload();
	...
	xhr.open("GET","addon_fruit_details.php?bill_no="+sno+"&peti="+peti+"&dabba="+dabba+"&ledger_id="+ledger_id+"&variety="+variety+"&quality="+quality+"&rate="+rate+"&amount="+amount+"&date="+date+"&ledger="+ledger,true);
	xhr.send();
...
function delete_fruit_sale(sno)
{
	 var xhr = new XMLHttpRequest();
	xhr.onreadystatechange = function()
	{
...
//      location.reload();
		alert(xhr.responseText);
		ledger_types(g_ledger,g_name,search_query);
		//document.getElementById("display-pod").innerHTML = xhr.responseText;
		}
	}
	xhr.open("GET","delete_fruit_details.php?bill_no="+sno,true);
	xhr.send();
...
//	{
			...
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(13,'search_fruit_sale')\">search fruit sale</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(14,'search_goods_receipt')\">search goods receipt</a> </td></tr>";
			echo "<tr><td class = \"lio\" style = \"padding:1px;\"><a style = \"text-decoration:none;cursor:pointer;font-size:12px;display:block;background-color:white;padding:6px;text-transform:capitalize;border-radius:0px;border-bottom-style:solid;border-color:pink;border-width:1px;color:grey;\" onclick = \"ledger_types(15,'search_khata')\">search khata</a> </td></tr>";
