...
//echo "<div style = \"text-align:right;\"><button class = \"control_buttons\" onclick = \"confirm_sales(".$transaction_type.")\">Confirm</button><button class = \"control_buttons\" oncclick >Cancel</button></div>";
?>
