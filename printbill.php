...
$query_daybook = mysqli_query($con,"select * from daybook join ledgers using (ledger_id) where transaction_type = 15 and transaction_id= $bill_no");
...
*/
echo "<tr><td colspan = '7'>Watak / Sale # <span style = 'color:navy;font-weight:bold;'>$bill_no</span><br>Name : <span style = 'color:navy;font-weight:bold;text-transform:capitalize;'>".$p_name."</span><br>";
echo "Date : <span style = 'color:navy;font-weight:bold;'>".$date."</span>";
echo "</td></tr>";




echo "<tr><td class = 'center_text' style = 'width:100px;'>Khata</td><td class = 'center_text' style = 'text-align:right;'>P</td><td class = 'center_text'>H</td><td class = 'center_text' style = 'font-size:15px;'>Kind</td><td class = 'center_text'>Grade/Lyr</td><td class = 'center_text' style = 'text-align:center;width:60px;'>Rate</td><td class = 'center_text' style = ''>Amount</td></tr>";
...
$query = mysqli_query($con,"select * from fruit_sale_detail where bill_no = '".$bill_no."'");
$sum = 0;
while($row_item = mysqli_fetch_array($query))
{
	//echo $row['peti'];
	echo "<tr style = 'font-size:14px;'><td style = 'text-align:left;'>".$row_item["khata"]."</td><td style = 'text-align:left;'>".$row_item["peti"]."</td><td style = 'text-align:left;'>".$row_item['dabba']."</td><td style = 'text-align:left;font-size:12px;'>".$row_item['variety']."</td><td style = 'text-align:center;margin-left:5px;font-size:12px;width:100px;'>".$row_item['quality']."</td><td style = 'text-align:right;'>".$row_item['rate']."</td><td style = 'text-align:right;'>".$row_item['amount']."</td>";
	echo "</tr>";
...
echo "</tr>";
echo "<tr style = 'font-weight:bold;color:navy;'><td></td><td style = 'text-align:right;'>$tot_peti</td><td style = 'text-align:right;'>$tot_dabba</td><td colspan = '3' style = 'text-align:center;'>Total</td><td style = 'text-align:right;'>".sprintf("%.2f",$tot_amount)."</td></tr>";
